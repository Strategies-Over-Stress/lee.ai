...
const features: Feature[] = [
  ...
  },
  {
    ...
    title: "AI is your competitive edge — if you know how to use it",
    subtitle: "Your competitors are figuring out prompts. You'll have production software.",
    stat: "80%",
    statLabel: "of AI projects fail without proper engineering guidance — Rand, 2025",
    description: "AI lets me build faster and cheaper than any traditional agency — but raw AI isn’t enough. Most businesses try it, get garbage out, and give up. I pair AI speed with a decade of engineering judgment so you get the cost savings AND the quality. Your competitors are still figuring out prompts. You’ll have production software.",
    highlights: [
      "AI-powered delivery at a fraction of traditional cost",
      "Every line reviewed by a senior engineer — no AI slop ships",
      "Your competitors are still experimenting. You’ll be deployed.",
      "Compliance and security built in from day one",
    ],
  },
  {
    id: "autonomous",
    icon: <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#818cf8" strokeWidth="2" strokeLinecap="round"><circle cx="12" cy="12" r="10"/><path d="M12 16v-4M12 8h.01"/></svg>,
    title: "You don’t have to tell me what to build",
    subtitle: "I find the problems myself. You approve the solutions.",
    stat: "∞",
    statLabel: "ideas you’ll never have to come up with yourself",
    description: "Most contractors wait for a spec. I dig into your operations, find where you’re bleeding money, and propose what to build — then build it. At this price point, experimentation is cheap. If something doesn’t work, we try the next thing. No six-figure risk.",
    highlights: [
      "Proactive problem-finding, not just order-taking",
      "Low price point makes experimentation safe",
      "Continuous improvement — not a one-and-done project",
    ],
  },
  {
    id: "duct",
    ...
    subtitle: "Replace duct-tape automations with real integrations.",
    stat: "$6/mo",
    statLabel: "replaces $100+/month in duct-tape automation",
    description: "You’ve got one tool connecting to your CRM to your spreadsheet to your calendar. 20 steps. $100+/month. One break and the whole chain goes down. I replace duct-tape integrations with real systems that run reliably on your own infrastructure.",
    highlights: [
      "Replace $100+/month automation chains with $6/month solutions",
